...
Run the development server, suppplying reflect-server index.ts, and update the Reflect constructor to talk to it:

```bash copy
npx reflect dev --server-path ./path/to/reflect-server/index.ts
```
