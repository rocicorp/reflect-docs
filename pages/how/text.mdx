...
For complete working examples for a variety of popular editors, see the [GitHub repo](https://github.com/rocicorp/reflect-yjs/tree/main/examples).

</Steps>

## Validation

You can apply server-side validation to Yjs documents, just like other Reflect data.

In your Reflect server, override the default `updateYJS` mutator to provide a validator:
