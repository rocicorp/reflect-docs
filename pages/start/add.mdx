...
[Join the Reflect Discord](https://discord.reflect.net/) and say "hi". If you run into any problems with these steps or have questions, post them here and we'll get right back to you.
...
To register your mutators with the server, create a new directory called `reflect-server` anywhere in your project, and add an `index.ts` file to it. This will be the entrypoint to your server code.
...
{
  "server": "./path/to/reflect-server/index.ts"
}
```
