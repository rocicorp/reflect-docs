...
<APIResource method="GET" path="/rooms/{uri-encoded-room-id}" />
...
<APIResource method="GET" path="/rooms" />
...
<APIResource method="POST" path="/rooms/{uri-encoded-room-id}:create" />
...
<APIResource method="POST" path="/rooms/{uri-encoded-room-id}:close" />
...
<APIResource method="POST" path="/rooms/{uri-encoded-room-id}:delete" />
