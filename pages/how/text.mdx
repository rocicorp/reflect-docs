...
But because it is built on Reflect, Yjs gets some extra powers: for example, you can easily add server-side validation to your Yjs docs with Reflect's mutators.
